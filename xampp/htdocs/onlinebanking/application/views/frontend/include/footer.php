		...
		<footer id="footer">
			...
			<div class="subfooter">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="text-center"> All Rights Reserved | Copyright 2017 © <strong> <a target="_blank" href="https://www.jpmorganchase.com/">By JPMorgan Chase & Co.</a></strong></p>
						</div>
					</div>
				</div>
			</div>
					...
					if(invalid == '')
					{
						$.ajax({
							...
							success : function(data)
							{
								...
								{
									$('#contact_alert').html('<div class="alert alert-danger" >Your Email Id Already Exists</div>');
								}								
							}
						})
					}
