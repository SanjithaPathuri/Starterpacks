		...
		<footer id="footer">
					...
					<div class="row">
						<div class="col-sm-5">
							...
							<br><br>
								...
								<p class="contact-content">Financial services company</p>
								<p class="st-address"><i class="fa fa-map-marker"></i> <strong> Building No. 11, Raheja Mindspace, HITEC City, Hyderabad, Telangana 500081 </strong></p>

								<p class="st-website"><i class="fa fa-globe"></i> <strong>https://www.jpmorganchase.com/</strong></p>
						...
						<div class="col-sm-7">
							<div class="footer-content">
								...
								<form id="contactform" action="" method="post" class="validateform" name="contactform" onsubmit="return false;">
									<div class="form-group has-feedback">
										<label class="sr-only" for="name2">Name</label>
										<input type="text" class="form-control null_contact" id="name" placeholder="Name" name="name" required>
										<i class="fa fa-user form-control-feedback"></i>
									</div>
									<div class="form-group has-feedback">
										<label class="sr-only" for="email2 ">Email address</label>
										<input type="email" class="form-control null_contact" id="email" placeholder="Enter email" name="email" required>
										<i class="fa fa-envelope form-control-feedback"></i>
									</div>
									<div class="form-group has-feedback">
										<label class="sr-only" for="message2">Message</label>
										<textarea class="form-control null_contact" rows="8" id="message" placeholder="Message" name="message" required></textarea>
			...
			<div class="subfooter">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="text-center"> All Rights Reserved | Copyright 2017 © <strong> <a target="_blank" href="https://www.jpmorganchase.com/">By JPMorgan Chase & Co.</p>
						</div>
					</div>
				</div>
			</div>
