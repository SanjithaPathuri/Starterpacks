$(document).ready(function() {
		...
		$(add_button1).click(function(e){ 
			...
			{ 
				...
				$(wrapper1).append('<div class="india"><div class="remove"><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="row"><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr"><label class="control-label">Experierce Type</label><select style="width:100%;" id="ExperienceTypeId" name="exp['+y+'][ExperienceTypeId]" multiple><option value="">Select Experience Type</option><option value="1">Internship</option><option value="2">Job</option><option value="3">Project work</option><option value="4">R&amp;D</option></select></div></div><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr"><label class="control-label">Company Name</label><input type="text" class="form-control" name="exp['+y+'][CompanyName]" id="CompanyName" placeholder="Company Name" /></div></div></div></div><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="row"><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr"><label class="control-label">Year Starting</label><input type="text" class="form-control form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" name="exp['+y+'][StartDate]" id="StartDate" placeholder="Year Starting" readonly /></div></div><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr"><label class="control-label">Year End</label><input type="text" class="form-control form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" name="exp['+y+'][EndDate]" id="EndDate" placeholder="Year End" readonly /></div></div></div></div><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="row"><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr"><label class="control-label">Designation</label><input type="text" class="form-control" name="exp['+y+'][Designation]" id="Designation" placeholder="Designation" /></div></div><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr"><label class="control-label">Work Profile</label><input type="text" class="form-control" name="exp['+y+'][WorkProfile]" id="WorkProfile" placeholder="Work Profile" /></div></div></div></div><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="row"><div class="col-lg-6 col-md-6 col-sm-3 col-xs-12"><div class="form-group no-margin-hr" id="pwd"><label class="control-label">&nbsp;</label><button class="form-control btn btn-danger remove_field1" type="button"><i class="fa fa-trash-o"></i></button></div></div></div></div></div></div>');
				y++;
