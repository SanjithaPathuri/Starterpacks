function editfun(testimonialid)
{
	...
	$.ajax({
			type: "POST",
			url: base_url+"index.php/Testimonial/EditTestimonial",
...
function search_test(page)
			{
				...
				$.ajax({
					...
					success:function(data)
					{
						...
						{
							$("#test_table").find('tbody').html("<tr><td colspan='8'><p style='margin-bottom:0px; text-align:center;'>No Records Found...!</p> </td></tr>")
							$("#pagination").show()
						}
					}					
				})
...
function deletefun(testimonialid)
{
	if(confirm("Are you sure You want to delete this record?"))
	{
		$.ajax({
				type: "POST",
				url: base_url+"index.php/Testimonial/DeleteTestimonial",
				data : "testimonialid="+testimonialid,
				success: function(data)
				{
