...
var file ;
	...
	$('#ShareYourKnowledgebtn').click(function(){
		var err ='0';
		var share_heading =$.trim($('#share_heading').val());
		var share_desc = $.trim(CKEDITOR.instances.share_desc.getData());
		if(share_heading == '')
		{
			err = '1';
			$('#share_heading').css('border','1px solid red');
		}
		else
		{
			$('#share_heading').css('border','');
		}
		if(share_desc == '')
		{
			err = '1';
			$('#cke_share_desc').css('border','1px solid red');
		}
		else
		{
			$('#cke_share_desc').css('border','');
		}
		if(err == '0')
		{
			$.ajax({
				url : "",
				data : {'share_heading':share_heading,'share_desc':share_desc,'type':'ShareYourKnowledge'},
				type:"POST",
				beforeSend: function()
				{
					$("#loading").show();
				...
				success : function(data){
					...
					alertify.alert("Share Your Knowledge Information Updated Successfully");
				}
			})
		}
	});
	$('#FindTalentbtn').click(function(){
		var err ='0';
		var FindTalent_heading =$.trim($('#FindTalent_heading').val());
		var find_talent_desc = $.trim(CKEDITOR.instances.find_talent_desc.getData());
		if(FindTalent_heading == '')
		{
			err = '1';
			$('#FindTalent_heading').css('border','1px solid red');
		}
		else
		{
			$('#FindTalent_heading').css('border','');
		}
		if(find_talent_desc == '')
		{
			err = '1';
			$('#cke_find_talent_desc').css('border','1px solid red');
		}
		else
		{
			$('#cke_find_talent_desc').css('border','');
		}
		if(err == '0')
		{
			$.ajax({
				url : "",
				data : {'FindTalent_heading':FindTalent_heading,'find_talent_desc':find_talent_desc,'type':'FindTalent'},
				type:"POST",
				beforeSend: function()
				{
					$("#loading").show();
				...
				success : function(data){
					...
					alertify.alert("Find Talent Information Updated Successfully");
				}
			})
		}
	});
	$('#ManageEventsbtn').click(function(){
		var err ='0';
		var event_heading =$.trim($('#event_heading').val());
		var event_desc = $.trim(CKEDITOR.instances.event_desc.getData());
		if(event_heading == '')
		{
			err = '1';
			$('#event_heading').css('border','1px solid red');
		}
		else
		{
			$('#event_heading').css('border','');
		}
		if(event_desc == '')
		{
			err = '1';
			$('#cke_event_desc').css('border','1px solid red');
		}
		else
		{
			$('#cke_event_desc').css('border','');
		}
		if(err == '0')
		{
			$.ajax({
				url : "",
				data : {'event_heading':event_heading,'event_desc':event_desc,'type':'ManageEvents'},
				type:"POST",
				beforeSend: function()
				{
					$("#loading").show();
				...
				success : function(data){
					...
					alertify.alert("Manage Events Information Updated Successfully");
				}
			})
		}
	});
