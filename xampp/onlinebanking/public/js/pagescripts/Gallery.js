$(function(){
	...
	$("#gallery_form").validate({
		...
		submitHandler: function() {		
			alert();
			$.ajax({
				url: base_url+"AdminGallerys/CategorieADD",
				type:"POST",
...
function del(id)
{
	alertify.confirm("Deleting this Category clears category Albums and <br> Album Images completely !<br> Do you want to continue ?", function (e) {
		if (e) 
		{
			$.ajax({
				url: "",
				type: "POST",
				data:{'id':id,'Delete':'Category'},
				beforeSend: function()
				{
					$(".deleteCatBtn").hide()
				},
