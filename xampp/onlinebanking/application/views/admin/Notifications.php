...
<div id="about" class="container-fluid">
  <div class="row">
	<div class="col-sm-2">
		...
		<a  href="<?php echo base_url('admin/Notifications'); ?>"  class="btn btn-warning btn-block">Notifications</a><br>
	...
	<div class="col-sm-9">
		...
		<div style="padding-top:10px">
			...
			<h3 style="text-align:center;color:#DAA520"><b>List of Notifications</b></h3><br><br>
		...
		success:function(data){
			...
			{			
				$.each(data.records, function(i){
					...
					html += '</td>';
					html += '<td>';
					html +=  row.Notification + ' ( on ' +row.Date + ' ) ';
					html += '</td>';
					html += '<td>';
					html +=  row.Location;
					html += '</td>';
