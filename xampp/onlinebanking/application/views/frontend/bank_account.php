...
<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 id="about" class="title text-center">Bank Admin account </h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-sm-4">
			...
			<div class="col-md-12">				
				...
				<form onsubmit="return false;" id="search_form">
					<div class="row">
						...
						<div class="col-sm-4">
							<a href="<?php echo base_url().'Welcome/re_payment'; ?>" class="btn btn-warning btn-block">Re-payment</a>
							<p>Click the above button to navigate to re-payment</p>
						</div>
		...
		success:function(data){
			...
			{			
				$.each(data.records, function(i){
					...
					else {row.ApproveStatus = 'Proccessing'; }
					...
					if(row.ApproveStatus == 'Closed'){
						...
						html +=  '<button class="btn btn-success btn-sm" onclick="approve('+row.ID+')" >Approve</button> &nbsp;&nbsp;<button class="btn btn-danger btn-sm"  onclick="reject('+row.ID+')" >Reject</button>';						
					}
					html += '</td>';
					html += '</tr>';
				});
