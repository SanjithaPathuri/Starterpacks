					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="site-name-and-slogan smooth-scroll">
								<div class="site-name"><a href="<?php echo base_url(); ?>">Online Banking</a></div>
									...
									<div class="container-fluid">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											...
											<?php if($this->session->userdata('UserId') == "" && $this->session->userdata('MemberId') == ""){ ?>
												...
												<li><a href="<?php echo base_url('Welcome/Login'); ?>">User Login</a></li>
											...
											<?php } else if($this->session->userdata('MemberId') != ''){ ?>
												...
												<li><a href="<?php echo base_url('Welcome/About'); ?>">About</a></li>
												<li><a href="<?php echo base_url('Welcome/Services'); ?>">Services</a></li>
												<li><a href="<?php echo base_url('Welcome/APIS'); ?>">API's</a></li>
											...
											<?php }else{ ?> 
												...
												<li><a href="<?php echo base_url('Welcome/Services'); ?>">Services</a></li>
												<li><a href="<?php echo base_url('Welcome/Login'); ?>">User Login</a></li>
												<li><a href="<?php echo base_url('Welcome/Bank_login'); ?>">Doctors Login</a></li>
												<li><a href="<?php echo base_url('Welcome/Contact'); ?>">Contact</a></li>
